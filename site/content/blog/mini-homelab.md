...
![Screenshot of output from nerdctl stats, showing resource usage stats from currently running containers on my homelab setup](https://media.cybar.dev/site/mini-homelab.webp "Container Resource Usage")
...
At first I thought of using the usual [Prometheus](https://prometheus.io/), [Grafana](https://grafana.com/), etc. stack to learn their usage in a hands-on environment, but after reading online about the hardware requirements, I decided against it. After looking a bit more I came across [Glances](https://github.com/nicolargo/glances). Imagine htop but with a web UI — that's Glances.
